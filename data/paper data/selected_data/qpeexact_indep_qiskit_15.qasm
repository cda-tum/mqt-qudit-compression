...
qreg psi[1];
creg c[14];
u2(-2.3836741,-pi) q[13];
u3(pi,-1.3466434,-pi) psi[0];
cz psi[0],q[0];
u3(1.3466434,-pi/2,pi/2) q[0];
cz psi[0],q[0];
u1(1.1224904) psi[0];
cz psi[0],q[1];
u2(-1.3466434,-pi) q[0];
u3(0.44830589,pi/2,-pi/2) q[1];
cz psi[0],q[1];
cz psi[0],q[2];
u2(0.44830588,-pi) q[1];
u3(0.89661175,pi/2,-pi/2) q[2];
cz psi[0],q[2];
cz psi[0],q[3];
u2(0.89661175,-pi) q[2];
u3(1.3483691,-pi/2,pi/2) q[3];
cz psi[0],q[3];
cz psi[0],q[4];
u2(-1.3483691,-pi) q[3];
u3(0.44485443,pi/2,-pi/2) q[4];
cz psi[0],q[4];
cz psi[0],q[5];
u2(0.44485443,-pi) q[4];
u3(0.88970885,pi/2,-pi/2) q[5];
cz psi[0],q[5];
cz psi[0],q[6];
u2(0.88970885,-pi) q[5];
u3(1.3621749,-pi/2,pi/2) q[6];
cz psi[0],q[6];
cz psi[0],q[7];
u2(-1.3621749,-pi) q[6];
u3(0.41724278,pi/2,-pi/2) q[7];
cz psi[0],q[7];
cz psi[0],q[8];
u3(0.41724277,-pi/2,pi/2) q[7];
cz q[6],q[7];
u2(0,pi) q[6];
u2(0,pi) q[7];
cz q[7],q[6];
